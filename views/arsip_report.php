        ...
        <div class="col-xs-12">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title"><span class="fa fa-user-plus"></span> Laporan Arsip Penerimaan Laporan</h3>
                </div>
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="17%">Jenis Pelanggaran</th><th>Nama Pelapor</th><th>Tempat Kejadian</th><th width="10%">Tanggal Masuk laporan</th><th>Pihak Terlapor</th><th>Kronologi Kejadian</th><th>Bukti Dugaan Pelanggaran<th>Staff Penerima Laporan</th></th><th>AKSI</th>
                            </tr>
                        </thead>
                        <tbody>
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="9">
                                    <a href="report/arsip_semua.php" target="_blank" class="btn btn-success btn-sm">
                                        <span class="fa fa_print"></span> Cetak Semua Arsip Penerimaan Laporan
